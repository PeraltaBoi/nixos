...
3. You should probably change the home/tiago directory to your username too

4. Create a home/<your-username>/code/private.nix file with this format:
```nix
{
...
5. Create a symlink for the system configuration:
```bash
sudo ln -s $(pwd)/configuration.nix /etc/nixos/configuration.nix
```

6. Build and switch to the new configuration:
```bash
